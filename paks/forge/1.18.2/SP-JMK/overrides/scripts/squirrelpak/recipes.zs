craftingTable.addShapeless("scsp_jmk_book1", <item:patchouli:guide_book>.withTag({"patchouli:book": "patchouli:scsp_jmk_guide" as string}), [<item:minecraft:paper>, <tag:items:minecraft:dirt>]);
