# SquirrelPAK Licenses

## SquirrelCraft SquirrelPAK Source Files
...
The below mods are not hosted on Modrinth and the jar files are being included with this PAK. With that the licenses are being included per the licenses agreement.
