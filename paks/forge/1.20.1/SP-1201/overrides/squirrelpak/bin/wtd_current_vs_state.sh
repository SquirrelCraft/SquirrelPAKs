...
#     wtd_current_vs_state.sh [OtherModList]
#     v1.1.1
# 

#     wtd_current_vs_state.sh - Shows the diff between current and directory state
...
echo " "
echo " ----------------------------------------------------------------------------"
echo "  SquirrelPAK Release Diff Tool (Current vs State) v1.1.1"
echo "  (wtd_current_vs_state.sh) - Licnesed under GNU GPLv3"
echo " ----------------------------------------------------------------------------"
...
$PAK_bin_dir/wtd.sh $PAK_versons_dir/$PAK_Current_State_ModListName $PAK_versons_dir/$PAK_Current_Version true
echo " "
echo "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
echo " "
