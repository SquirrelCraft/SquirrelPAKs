...
#
#     Internal script
#     Shows the diff between current and directory state
#     wtd_current_vs_snapshot.sh
#     v1.0
# 

#     wtd_current_vs_snapshot.sh - Shows the diff between current mod 
#     directory state vs the snapshot taken with the take_snapshot.sh
#     script.
#
...
echo " "
echo " ----------------------------------------------------------------------------"
echo "  SquirrelPAK Release Diff Tool (Current vs Snapshot) v1.0"
echo "  (wtd_current_vs_snapshot.sh) - Licnesed under GNU GPLv3"
echo " ----------------------------------------------------------------------------"
...
echo " "
echo "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
echo " Whats The Diff between current vs snapshot"
echo "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="    
echo "    [Key Codes]"
echo "|  = Mod Updated"
echo "<  = Mod Added"
...
$PAK_bin_dir/wtd.sh $PAK_versons_dir/$PAK_Current_State_ModListName $PAK_versons_dir/$PAK_Snapshot_ModListName true
echo " "
echo "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
echo " "
