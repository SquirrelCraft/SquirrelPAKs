...
echo " "
echo " ----------------------------------------------------------------------------"
echo "  SquirrelPAK CF Export Script v4.3"
...
mv -v resourcepacks $PAK_Removed_Files_Export_Dir/

echo " "
echo " Moving patchouli_books..."
mv -v patchouli_books $PAK_Removed_Files_Export_Dir/
